...
###Note
#result.sim represents win/lose status for each game
#result.bet represents total bet for each game
#result.sim.sum represent amount of money won/lost.

#Proportion of win/draw/lose/Blackjack(win)
table(result.sim) / (iter*sim.iter)
